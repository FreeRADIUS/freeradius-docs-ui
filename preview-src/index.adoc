...
:!example-caption:
:!table-caption:
:page-copyright: Copyright 2020
:page-license: CC-BY-NC 4.0
...
.This is the title
****
This is an example paragraph This is an example paragraph This is an example paragraph This is an example paragraph This is an example paragraph 
